class User < ApplicationRecord
  ...
  validates :last_name_pseudonym_reading, presence: true, format: { with: /\A[ァ-ヶ一]+\z/, message: '全角カタカナを使用してください' }
  validates :first_name_pseudonym_reading, presence: true, format: { with: /\A[ァ-ヶ一]+\z/, message: '全角カタカナを使用してください' }
