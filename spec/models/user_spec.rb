  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できない場合' do
      ...
      it 'last_name_pseudonym_readingが空では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name pseudonym reading can't be blank", "Last name pseudonym reading is invalid")
      end
      it 'first_name_pseudonym_readingが空では登録できない' do
        @user.first_name_pseudonym_reading = ''
        @user.valid?
        expect(@user.errors.full_messages).to include("First name pseudonym reading can't be blank", "First name pseudonym reading is invalid")
      end
